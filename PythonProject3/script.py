...
def run():
    ...
    st.markdown('<div class="overlay-title"><h1>🔋 Degradation Rate Prediction</h1></div>',
                unsafe_allow_html=True)
    ...
    if st.button("🔮 Predict Degradation"):
       ...
       'Reaction_Rate_J',  'Graphene_Enhanced', 'SEI_Growth_Proxy_Enhanced',
       'Plating_Risk_Proxy_Enhanced',
